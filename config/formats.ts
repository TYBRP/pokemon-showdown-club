...
export const Formats: FormatList = [
	...
	{
		name: "[Gen 8] Battle Dome",
		desc: "Remember the Battle Dome in Emerald? Sure you don't. It has now been revived for Gen 8 using the power of battle sims!",
		mod: 'gen8',
		ruleset: ['Obtainable', 'Team Preview', 'Dynamax Clause', 'Max Team Size = 3', 'Adjust Level = 50', 'Min Team Size = 3', 'Item Clause', 'Picked Team Size = 2', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause'],
	...
	{
		section: "If Sword and Shield had Triple Battles"
	},
	{
		name: "[Gen 8] Battle Spot Triples",
		threads: [
